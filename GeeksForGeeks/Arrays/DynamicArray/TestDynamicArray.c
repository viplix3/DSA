...
int main(int argc, char *argv[]){
	...
	printf("\n***** The array won't show element 555 at index 4 even though it is valid as setItem() is a low level function. \
	It will insert the given value but won't increment array size and the inserted value will be lost for any index beyond array size *****\n");
	setItem(array, 7, 555);
